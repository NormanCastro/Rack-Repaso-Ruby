...
personas_hash = {1 => ["Luis", "Argentina", "Sudamericano", "Masculino"], 2 => ["Pedro", "Brasil", "Americano", "Masculino"], 3 => ["Flor", "Colombia", "Americano", "Femenino"], 4 => ["Hency", "Venezuela", "Americano", "Femenino"], 5 => ["Michel", "Francia", "europeo", "Masculino"], 6 => ["Jengh", "Tokio", "Asiático", "Masculino"], 7 => ["Kym", "Francia", "Europeo", "Femenino"], 8 => ["Pedro", "Canadá", "Americano", "Masculino"] }
